...
return [
    ...
    | ajuster chaque message selon vos besoins.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute fourni est apparu dans une fuite de données. Veuillez en choisir un différent.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ces lignes sont utilisées pour remplacer le placeholder :attribute
